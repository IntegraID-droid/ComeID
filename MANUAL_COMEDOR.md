...
- **Admin / Profesor** → Panel de administración del comedor (estudiantes, escaneo QR de asistencia, menú semanal, invitados, reportes).
- **Estudiante** → Portal de estudiantes (menú del día, su asistencia al comedor, notificaciones).

En el módulo de comedor, la operación diaria típica es: **iniciar sesión → abrir Escanear QR → marcar al estudiante que come → exportar la lista del día**. El flujo se detalla sección por sección en los capítulos siguientes.
